...
#'    \item gitignore - this will be a skeleton of a gitignore which
#'    will automatically include all the usual R related files, but also
#'    the 01_data and 03_outputs folders.
#' }
#'
