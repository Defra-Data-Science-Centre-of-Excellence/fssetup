...
As mentioned, the `fssetup` package aims to help standardise the use of R across Farming Stats and make R easier to use for poeple newer to coding. It is still very much a package in development, so we would welcome any and all feedback. We are particularly interested to hear of any functions you would like to see added, or any process in getting started in R that you struggle with, as we might be able to incorporate these into future versions.
